export async function api_get_OldCorreli_By_Ci(ci) { //oldCorreli
...
export async  function api_get_NewCorreli_by_Ci(ci) {
  let result = new Promise((resolve, reject) => {
    var requestOptions = {
      method: 'GET',
      redirect: 'follow'
...
export async function api_get_NewPersona_by_Ci(ci) {
  let result = new Promise((resolve, reject) => {
    var requestOptions = {
      method: 'GET',
      redirect: 'follow'
...
export function api_update_NewCorreli(data) {
  ...
  let result = new Promise((resolve, reject) => {
    ...
    var raw = JSON.stringify({
      ...
      "id_new_correli": data.id_new_correli,
      "latitud": data.latitud,
      "longitud": data.longitud,
      "email": data.email,
      "foto": data.foto,
    ...
    fetch("https://colorados-mds.herokuapp.com/new/update_new_correli/", requestOptions)
      .then(response => response.text())
      .then(result => { resolve(JSON.parse(result)); })
      .catch(error => console.log('error', error));
