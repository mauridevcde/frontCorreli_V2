...
export async function api_get_MovimientosAll() {
...
export async function api_get_Movimientos_by_id(id) {
  let result = new Promise((resolve, reject) => {
    var requestOptions = {
      method: 'GET',
      redirect: 'follow'
...
export async function api_update_movimientos(data) {
  ...
  let result = new Promise((resolve, reject) => {
      ...
      fetch("https://colorados-mds.herokuapp.com/new/update_movimiento/", requestOptions)
          .then(response => response.text())
          .then(result => { resolve(JSON.parse(result)); })
          .catch(error => console.log('error', error));
...
export async function api_delete_movimientos(data) {
  ...
  let result = new Promise((resolve, reject) => {
      ...
      fetch("https://colorados-mds.herokuapp.com/new/delete_movimiento/", requestOptions)
          .then(response => response.text())
          .then(result => { resolve(JSON.parse(result)); })
          .catch(error => console.log('error', error));
