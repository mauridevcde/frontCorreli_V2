...
import { api_post_ListaForPuntero } from "../apis/apiListas.js";
        ...
        if (ci.value == "" || ci.value == "0" || ci.value == null || ci.value == undefined || ci.value == " ") {
            ...
            if (VerificadorCi == 1) {
                ...
                window.btnGurdarNuevaPersona.addEventListener("click", (e) => {
                    ...
                    console.log("🚀 ~ file: Persona.js ~ line 236 ~ window.btnGurdarNuevaPersona.addEventListener ~ datosNuevaPersona", datosNuevaPersona)

                    if (validaObject(datosNuevaPersona)) {
                        console.log("🚀 ~ file: Persona.js ~ line 239 ~ window.btnGurdarNuevaPersona.addEventListener ~ datosNuevaPersona", datosNuevaPersona)
                        //console.log("true");
                        ...
                        post_Persona(datosNuevaPersona).then((res) => {
                            console.log("🚀 ~ file: Persona.js ~ line 244 ~ post_Persona ~ datosNuevaPersona", datosNuevaPersona)
                            if (res.message == 'ok') {
                                Swal.fire({
                                    icon: 'success',
