      ...
      <nav class="navbar navbar-expand-lg navbar-light navegacion-Prin" style="background-image: linear-gradient(-225deg, #FFFEFF 0%, #D7FFFE 100%);">
        ...
        <div class="navbar-brand" id="logoNavBarSecundario" style="margin-left: 80px;">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a  id="ComandoBtn" class="btn btn-info  btn-lg text-white" style="background-color:#E2504C; border-color:#E2504C; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
            <i class="fa fa-flag" aria-hidden="true"></i>
            <br>Comando</a>

            <a  id="dirigenteBtn" class="btn btn-info  btn-lg text-white" style="background-color:#E2504C; border-color:#E2504C; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
            <i class="fa fa-flag" aria-hidden="true"></i>
            <br>Dirigente</a>
