...
export function tablaComando(props) {
    ...
    return /*html*/ `
      ...
      <h4 class="text-center" style="color:white">Comando </h4>
...
export function modalNuevoEditarComando() {
    return /*html*/ `
    <div class="modal fade" id="modalNuevoEditarComando"  tabindex="-1" role="dialog" aria-labelledby="ComandoModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document" style="max-width:1300px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title  m-auto" id="ComandoNuevoEditar">NUEVAS COMANDOS</h5>
            </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <form>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="inpNombreComando" style="text-transform:uppercase; color:red">NOMBRE Comando :</label>
