...
import { api_get_ListaAll, api_post_Lista, api_update_Lista, api_delete_Lista } from '../apis/apiListas.js';
...
async function botoneraTable(Lista, view, dirigentes, movimientos, punteros) {
    ...
    Ver_Editar_Modal_Table(Lista, view, dirigentes, movimientos, punteros);
    deleteLista_Table()
}
