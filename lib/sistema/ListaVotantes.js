...
if (localStorage.getItem('id_grupo_AddLista') == "noExiste") {
    ...
    $('#modalSeleccionarGrupoLista').modal({ backdrop: 'static', keyboard: false });
    $('#modalSeleccionarGrupoLista').modal('show');
    ...
    window.btnGuardarNuevoGrupoLista.addEventListener("click", async () => {
        ...
        $('#modalSeleccionarGrupoLista').modal('hide');
