                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <form>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="inpNombreComando" style="text-transform:uppercase; color:red">NOMBRE - Apellido :</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inpTelefonoComando" style="text-transform:uppercase">
                                        <small class="form-text text-muted">Este campo es obligatorio.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="lblCedula" style="text-transform:uppercase; color:red" >Cedula de Identidad :</label>
                                        <input type="text" class="form-control" id="inpCiComando" style="text-transform:uppercase">
                                        <small class="form-text text-muted">Este campo es obligatorio.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="lblEmail" style="text-transform:uppercase; color:red" >Email / Correo :</label>
                                        <input type="text" class="form-control" id="inpEmailComando" style="text-transform:uppercase">
                                        <small class="form-text text-muted">Este campo es obligatorio.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="lblPassword" style="text-transform:uppercase; color:red" >Password :</label>
                                        <input type="password" class="form-control" id="inpPasswordComando" style="text-transform:uppercase">
                                        <small class="form-text text-muted">Este campo es obligatorio.</small>
                                    </div>
