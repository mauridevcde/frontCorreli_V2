            ...
            <div class=" rounded mb-4" >
                ...
                <input type="text" class="form-control" id="inputCorreo">
                    ...
                    <div id="contImagen2" class= "mb-3">
                        ...
                        <img src="" alt="" id="imgPreviewImageNewProducto" class="imgPreviewImageNewProducto">
                    ...
                    <div class="mb-4 d-flex justify-content-center">
                        ...
                        <button type="submit" class="btn btn-primary" id="btnNewCorreli";"><i class="fas fa-check"></i> Nuevo</button>
                    </div>
                </div>
            </div>
        </div>
