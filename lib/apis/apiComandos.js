...
export function api_update_comando(data) {
    ...
    let result = new Promise((resolve, reject) => {
        ...
        fetch("https://colorados-mds.herokuapp.com/new/update_comando/", requestOptions)
            .then(response => response.text())
            .then(result => { resolve(JSON.parse(result)); })
            .catch(error => console.log('error', error));
...
export function api_delete_comando(data) {
    ...
    let result = new Promise((resolve, reject) => {
        ...
        fetch("https://colorados-mds.herokuapp.com/new/delete_comando/", requestOptions)
            .then(response => response.text())
            .then(result => { resolve(JSON.parse(result)); })
            .catch(error => console.log('error', error));
