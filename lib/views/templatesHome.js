  ...
  if (localStorage.getItem('rol') == 'admin') {
    ...
    <div class="container" >
        <div class="card text-center" style="margin-top: 15%;box-shadow: 5px 5px 10px rgba(0,0,0,0.2); border-color: #C44D4D ; border-radius: 6px">
            ...
            <img src="./lib/img/partidoColorado.png" width="150px" style="border-radius:10px; box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;margin-bottom: 30px;"/>
              
            <div class="contenedorBotonesNavPrincipal" style="display: flex;justify-content: center; gap: 5px">
               ...
               <a  id="SistemaBtn" class="btn btn-info  btn-lg text-white" style="background-color:#EB8A87; border-color:#EB8A87; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
               <i class="fa fa-cog" aria-hidden="true"></i>
               <br>Sistema</a>

               <a  id="logOut" class="btn btn-info  btn-lg text-white" style="background-color:#EB8A87; border-color:#EB8A87; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
               ...
               <br>Cerrar Sesión</a>
                    ...
                    <div class="card-footer text-muted" style=" background-color: #C44D4D ; border-color: #C44D4D">
                      <a  style="color: white;text-transform: uppercase;" id="">${localStorage.getItem('rol')} - ${localStorage.getItem('user')}</a>
                    </div>
                </div>
        </div>
    </div>
    `
    return retornar
  }else if (localStorage.getItem('rol') == 'puntero'){
    console.log('soy puntero')
    retornar =  /*html */ `
    <div class="container" >
        <div class="card text-center" style="margin-top: 15%;box-shadow: 5px 5px 10px rgba(0,0,0,0.2); border-color: #C44D4D ; border-radius: 6px">
            <div class="card-header text-muted" style=" background-color: #C44D4D; color: white">
            ...
            <div class="contenedorBotonesNavPrincipal" style="display: flex;justify-content: center; gap: 5px">
               ...
               <a  id="punteroBtn" class="btn btn-success  btn-lg text-white" style="display: none; background-color: #EC2300; border-color: #EC2300; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
               <i class="fa fa-pencil-square" aria-hidden="true"></i>
               <br>Puntero</a>
...
export function navbar(props) {
  ...
  if (localStorage.getItem('rol') == 'dirigente') {
    dirigenteRender =  /*html*/`
    <div>
    <nav class="navbar navbar-expand-lg navbar-light navegacion-Prin" style="background-color:#ccc">

    <div id="contenedorLogoNavBarSecundario" style="display: flex;">
    <div class="navbar-brand" id="logoNavBarSecundario" >
    </div>
      ...
      <img src="./lib/img/partidoColorado.png" style="border-radius: 5px;" width="130px" />
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a  id="logOut2" class="btn btn-info  btn-lg text-white" style="background-color:#EB8A87; border-color:#EB8A87; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
          <i class="fa fa-sign-out" aria-hidden="true"></i>
          <br>Cerrar Sesión</a>
    ...
    <div class="navbar-brand" id="logoNavBarSecundario" >
      ...
      <img src="./lib/img/partidoColorado.png" style="border-radius: 5px;" width="130px" />
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a  id="listaBtn2" class="btn btn-info  btn-lg text-white" style="display:none;background-color:#E2504C; border-color:#E2504C; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
          <i class="fa fa-list" aria-hidden="true"></i>
          <br>Grupo</a>
          ...
          <a  id="logOut2" class="btn btn-info  btn-lg text-white" style="visibility:visible;background-color:#EB8A87; border-color:#EB8A87; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;" >
          <i class="fa fa-sign-out" aria-hidden="true"></i>
          <br>Cerrar Sesión</a>
