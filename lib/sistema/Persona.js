...
async function BuscarColo_o_PorCi() {
    ...
    btnBuscar.addEventListener('click', async function () {
        ...
        if (ci.value == "" || ci.value == null) {
            ...
            let personasAll = await getPersonasPorCi(ci.value);
            let datosColorados = await getColoradosPorCi(ci.value);
            ...
            //!=======================PERSONAS================================!
                ...
                console.log("personas filtrada", personasAll);
