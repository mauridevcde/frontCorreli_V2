  ...
  return /*html */ `
    <div class="container" >
        <div class="card text-center" style="margin-top: 15%;box-shadow: 5px 5px 10px rgba(0,0,0,0.2); border-color: #C44D4D ; border-radius: 6px">
            ...
            <div class="contenedorBotonesNavPrincipal" style="/*! margin: 0 auto; */display: flex;justify-content: center;margin-left: inherit;gap: 6px;margin-top: 20px;margin-left: 80px;">
