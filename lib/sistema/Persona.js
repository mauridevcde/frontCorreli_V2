...
async function BuscarColo_o_PorCi() {
    ...
    async function buscarPorCedula() {
        ...
        btnBuscar.addEventListener('click', async () => {
            ...
            if (New_Persona.length > 0) {
                ...
                console.log("la imagen", foto);
                        
               // previewImage.innerHTML = `<img src="${data:image/png;base64,${base64}}" class="img-fluid">`;
    ...
    function limpiarCampos() {
        ...
        document.getElementById('imagePreviewNewProducto').value = "";
        document.getElementById('imgPreviewImageNewProducto').value = "";
        document.getElementById('inpFileNewProducto').value = "";
        previewImage.setAttribute('src', '');
    }
}
